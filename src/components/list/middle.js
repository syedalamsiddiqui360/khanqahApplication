                        ...
                        return (<div class="col-md-6 col-lg-4 mb-4">
                            <div class="property-entry h-100">
                                ...
                                {props.listType == "audio" &&
                                    <Item name={value.name} audioUrl={value.fileName} price={value.place} description={value.description} tag1={value.tag1} tag2={value.tag2} tag1CN={value.tag1CN} tag2CN={value.tag2CN} imgSrc={value.imgSrc} date={value.date} />
                                }
                            </div>
                        </div>
                        )
