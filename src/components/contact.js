        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4"><a >+1 232 3235 324</a></p>

              <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a >youremail@domain.com</a></p>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
            <div class="team-member">
              ...
              <div class="text">
                ...
                <p>
                  <a  class="text-black p-2"><span class="icon-facebook"></span></a>
                  <a  class="text-black p-2"><span class="icon-twitter"></span></a>
                  <a  class="text-black p-2"><span class="icon-linkedin"></span></a>
                </p>
              </div>
